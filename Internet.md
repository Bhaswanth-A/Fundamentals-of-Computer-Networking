...
End systems connect to the Internet by communicationlinks, which is provided by the ISP and depends on a number of factors such as cost, location, range, speed, etc. They can be of the following types:
...
At the customer's end, a splitter is used to seperate the telephone channel and the Internet access channels. Similarly, the DSLAM at the CO seperates the telephone channel and Internet channels, and sends the data to the Internet.
...
### 4. Ethernet
Ethernet is a communication standard used to network computers and other devices in a LAN. It is defined in the IEEE 802.2 and 802.3 standards. 
Transmission rate: Supports bandwidths between 1Mbps - 100Gbps.

It a wired system that started with using coaxial cable and has now evolved to using twisted pair wiring and fiber optical cables. 
